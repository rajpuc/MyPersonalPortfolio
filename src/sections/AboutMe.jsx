  ...
  return (
    <section id="about" className='container mx-auto px-8 py-16'>
      ...
      <div className='flex flex-col lg:flex-row gap-16 items-start justify-between'>
        <div className="w-[300px] md:w-[370px] h-[350px] md:h-[428px] bg-[#dd9fa2]  rounded-3xl mx-auto">
          <img src={RajeshImg2} alt="Profile Pic" className='profile-pic rounded-[2.5rem]'/>
        </div>
        <div className="flex-1 ">
          ...
          <div className="flex gap-4 mt-6 ">
            {ABOUT_ME.socialLinks.map((item)=>(
              <a href={item.link} target='_blank' key={item.label} className='cursor-pointer group'>
