      ...
      <div className="container mx-auto px-8 md:px-10 py-10 ">
        <div className="w-full lg:w-[60vw] mx-auto ">
          ...
          <p className="text-sm text-center mt-4 leading-6 ">
            From concept to deployment, these projects highlight my expertise in
            the MERN stack. I prioritize clean code, performance optimization,
            and a seamless user experience to build scalable and efficient web
            applications.
          </p>
        </div>
